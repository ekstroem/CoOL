...
RcppExport SEXP _CoOL_SRCL_cpp_train_network_relu(SEXP xSEXP, SEXP ySEXP, SEXP testxSEXP, SEXP testySEXP, SEXP W1_inputSEXP, SEXP B1_inputSEXP, SEXP W2_inputSEXP, SEXP B2_inputSEXP, SEXP IPCWSEXP, SEXP lrSEXP, SEXP maxepochsSEXP, SEXP L1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
...
RcppExport SEXP _CoOL_SRCL_cpp_train_network_relu_with_confounder(SEXP xSEXP, SEXP ySEXP, SEXP cSEXP, SEXP testxSEXP, SEXP testySEXP, SEXP testcSEXP, SEXP W1_inputSEXP, SEXP B1_inputSEXP, SEXP W2_inputSEXP, SEXP B2_inputSEXP, SEXP C2_inputSEXP, SEXP lrSEXP, SEXP maxepochsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CoOL_SRCL_cpp_train_network_relu", (DL_FUNC) &_CoOL_SRCL_cpp_train_network_relu, 12},
    {"_CoOL_SRCL_cpp_train_network_relu_with_confounder", (DL_FUNC) &_CoOL_SRCL_cpp_train_network_relu_with_confounder, 13},
    {NULL, NULL, 0}
};
