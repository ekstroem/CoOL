...
Rcpp::List cpp_train_network_relu(const arma::mat& x, const arma::vec& y, const arma::mat& testx, const arma::vec& testy, const arma::mat& W1_input, const arma::mat& B1_input, const arma::mat& W2_input, const arma::mat& B2_input, double lr, double maxepochs, double input_parameter_reg);
RcppExport SEXP _CoOL_cpp_train_network_relu(SEXP xSEXP, SEXP ySEXP, SEXP testxSEXP, SEXP testySEXP, SEXP W1_inputSEXP, SEXP B1_inputSEXP, SEXP W2_inputSEXP, SEXP B2_inputSEXP, SEXP lrSEXP, SEXP maxepochsSEXP, SEXP input_parameter_regSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_train_network_relu(x, y, testx, testy, W1_input, B1_input, W2_input, B2_input, lr, maxepochs, input_parameter_reg));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CoOL_cpp_train_network_relu", (DL_FUNC) &_CoOL_cpp_train_network_relu, 11},
    {NULL, NULL, 0}
};
