...
#' @export
rcpprelu <- function(x) {
    .Call('_SRCL_rcpprelu', PACKAGE = 'SRCL', x)
}
...
rcpprelu_neg <- function(x) {
    .Call('_SRCL_rcpprelu_neg', PACKAGE = 'SRCL', x)
}
...
CoOL_cpp_train_network_relu <- function(x, y, testx, testy, W1_input, B1_input, W2_input, B2_input, IPCW, lr = 0.01, maxepochs = 100, L1 = 0.00001) {
    .Call('_SRCL_CoOL_cpp_train_network_relu', PACKAGE = 'SRCL', x, y, testx, testy, W1_input, B1_input, W2_input, B2_input, IPCW, lr, maxepochs, L1)
}
...
CoOL_cpp_train_network_relu_with_confounder <- function(x, y, c, testx, testy, testc, W1_input, B1_input, W2_input, B2_input, C2_input, lr = 0.01, maxepochs = 100) {
    .Call('_SRCL_CoOL_cpp_train_network_relu_with_confounder', PACKAGE = 'SRCL', x, y, c, testx, testy, testc, W1_input, B1_input, W2_input, B2_input, C2_input, lr, maxepochs)
}
